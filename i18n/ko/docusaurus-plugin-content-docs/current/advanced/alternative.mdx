...
### WireGuard
:::note
사이드스토어에서 WireGuard VPN은 **0.3.1-0.6.1 사이 버전과 0.6.3-nightly.4e6756d 버전에서만 작동하며**, 대체 수단(LocalDevVPN)이 있다면 사용을 권장하지 않아요. 해당 버전 외에서 작동하지 않을 경우 **이 문제에 대한 지원을 요청하지 말아주세요**. 
:::
...
#### 단계
1. SparseBox를 설치해 주세요. 다양한 방법이 있지만 여기서는 SideStore로 설치한다고 가정해요. 최신 버전은 [여기](https://github.com/khanhduytran0/SparseBox/releases/download/0.0.1/com.kdt.sparsebox_0.0.1.ipa)에서 받을 수 있어요.
